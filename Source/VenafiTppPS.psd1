...
@{
    ...
    FunctionsToExport = @('Add-TppCertificateAssociation', 'ConvertTo-TppGuid', 'ConvertTo-TppPath', 'Find-TppCertificate',        'Find-TppCodeSignEnvironment', 'Find-TppCodeSignProject',        'Find-TppCodeSignTemplate', 'Find-TppIdentity', 'Find-TppObject',        'Get-TppAttribute', 'Get-TppCertificate', 'Get-TppCertificateDetail',        'Get-TppCodeSignConfig', 'Get-TppCodeSignEnvironment',        'Get-TppCodeSignProject', 'Get-TppCustomField',        'Get-TppIdentityAttribute', 'Get-TppObject', 'Get-TppPermission',        'Get-TppSystemStatus', 'Get-TppVersion', 'Get-TppWorkflowTicket',       'Import-TppCertificate', 'Invoke-TppCertificateRenewal',        'Invoke-TppRestMethod', 'Move-TppObject', 'New-TppCapiApplication',        'New-TppCertificate', 'New-TppCodeSignProject', 'New-TppDevice',        'New-TppObject', 'New-TppPolicy', 'New-TppSession', 'New-TppToken',        'Read-TppLog', 'Remove-TppCertificate',        'Remove-TppCertificateAssociation', 'Remove-TppCodeSignEnvironment',        'Remove-TppCodeSignProject', 'Rename-TppObject',        'Revoke-TppCertificate', 'Revoke-TppToken', 'Set-TppAttribute',        'Set-TppCodeSignProjectStatus', 'Set-TppPermission',        'Set-TppWorkflowTicketStatus', 'Test-TppIdentity', 'Test-TppObject',        'Write-TppLog')
