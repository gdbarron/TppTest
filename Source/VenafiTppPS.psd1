...
PrivateData = @{
    ...
    PSData = @{
        ...
        LicenseUri = 'https://github.com/gdbarron/VenafiTppPS/blob/trunk/LICENSE'

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/gdbarron/VenafiTppPS'

        # A URL to an icon representing this module.
        IconUri = 'https://raw.githubusercontent.com/gdbarron/VenafiTppPS/trunk/images/Ven_circleV_logo.png'

        # ReleaseNotes of this module
        ReleaseNotes = 'https://github.com/gdbarron/VenafiTppPS/blob/trunk/CHANGELOG.md'
